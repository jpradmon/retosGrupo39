...
public class Fragment_Sucursales extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.su1, vist.getContext().getTheme());
        ...
        drawable2 = res2.getDrawable(R.drawable.su2, vist.getContext().getTheme());
        ...
        drawable3 = res3.getDrawable(R.drawable.su3, vist.getContext().getTheme());
